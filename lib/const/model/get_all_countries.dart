...
//
//     final getAllCountries = getAllCountriesFromJson(jsonString);

import 'dart:convert';

List<GetAllCountries> getAllCountriesFromJson(String str) =>
    List<GetAllCountries>.from(
        json.decode(str).map((x) => GetAllCountries.fromJson(x)));

String getAllCountriesToJson(List<GetAllCountries> data) =>
...
class GetAllCountries {
  ...
  factory GetAllCountries.fromJson(Map<String, dynamic> json) =>
      GetAllCountries(
